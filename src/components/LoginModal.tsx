      ...
      <DialogContent className='absolute z-[999]'>
        <DialogHeader>
          <div className='relative mx-auto size-24 mb-2'>
            <Image src={`/bepisHead.png`} alt='cute dog head' className='object-contain' fill/>
            </div>
        ...
        <div className='grid grid-cols-2 gap-6 divide-x divide-gray-200'>
          ...
          <RegisterLink className={`${buttonVariants({variant: "default"})} bg-yellow-800`}>Sign up</RegisterLink>
        </div>
      </DialogContent>
    </Dialog>
  )
